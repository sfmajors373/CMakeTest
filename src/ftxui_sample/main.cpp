...
// configuration step. It creates a namespace called `CMakeTest`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", CMakeTest::cmake::project_name, CMakeTest::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", CMakeTest::cmake::project_version);
      return EXIT_SUCCESS;
    }
